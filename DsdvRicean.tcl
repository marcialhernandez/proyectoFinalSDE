...
set val(txPower)         8.0                        ;# Potencia de transmisión en watts
...
set tracefd       [open DsdvRicean.tr w]
set windowVsTime2 [open win.tr w]
set namtrace      [open DsdvRicean.nam w]
...
set namfile [open outDsdvRicean.nam w]
