...
set val(packetSize__)             256               ;# routing protocol OLSR
set val(window__)             32               ;# routing protocol OLSR
...
set tracefd       [open OlsrShadow.tr w]
set windowVsTime2 [open win.tr w]
set namtrace      [open OlsrShadow.nam w]
...
set namfile [open outOlsrShadow.nam w]
...
# Set propagation settings - Modelo de Obstruccion
set prop_inst [$ns_ set propInstance_]
$prop_inst set pathlossExp_ 2.7; #Area urbana
$prop_inst set std_db_ 8; #Outdoor
$prop_inst set dist0_ 1.0
$prop_inst seed predef 0
